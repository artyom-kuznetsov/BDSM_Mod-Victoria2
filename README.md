ВНИМАНИЕ! Скачивайте последний релиз (Релизы видны справа страницы на github), а не сам репозиторий.

Ветка main - мод DoD_BDSM (основанный на Divergences of Darkness).
Ветка 1836_Freeze - классический BDSM мод на стандартной карте.


ЗАПУСК МОДА ЧЕРЕЗ 0_Launcher.exe В ПАПКЕ V2BDSM (или .bat файл сразу под ним)
