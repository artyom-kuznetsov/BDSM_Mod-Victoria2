...
Мод использует подмену .dll для расширения возможностей моддинга. Это наше собственное открытие. С помощью подмены .dll мы можем добавлять/редактировать
невозможные в ванили вещи, такие как добавление в интерфейс новых рабочих кнопок, изменение механики ценообразования, и огромное количество других вещей. 
Подробнее почитать, и увидеть исходный код модификаций игры, можете выбрав ветку balticsprott_V2DLL.
