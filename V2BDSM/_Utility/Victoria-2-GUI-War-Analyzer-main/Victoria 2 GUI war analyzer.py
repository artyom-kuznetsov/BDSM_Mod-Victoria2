...
class CultureLeaderMapper:
    ...
    def load_culture_group_mappings(state: AppState) -> Dict[str, str]:
        ...
        try:
            with open(cultures_path, 'r', encoding='windows-1251') as f:
                content = f.read()
...
class CBTypesParser:
    ...
    def parse_cb_types(state: AppState) -> Dict[str, int]:
        ...
        try:
            with open(cb_types_path, 'r', encoding='windows-1251') as f:
                content = f.read()
...
class LocalizationParser:
    ...
    def parse_localization_files(state: AppState) -> Dict[str, str]:
        ...
        for file_path in all_files:
            try:
                encodings = ['windows-1251', 'utf-8-sig', 'latin-1', 'cp1252', 'iso-8859-1', 'utf-8']
                content = None
