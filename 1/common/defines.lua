...
country = {
	...
	NEWSPAPER_PRINTING_FREQUENCY = 999, -- days frequency when the news attempt to be printed (may not print if not enough facts collected, and retry after another X days)
	NEWSPAPER_TIMEOUT_PERIOD = 999, -- the max period for news that may be printed. The probability is decreased with time.
...
military = {
	...
	POP_MIN_SIZE_FOR_REGIMENT = 1200,
	POP_SIZE_PER_REGIMENT = 3600,
...
diplomacy = {
	...
	TENSION_FROM_MOVEMENT_MAX = 0.8, -- max total value no matter the size of the movement
