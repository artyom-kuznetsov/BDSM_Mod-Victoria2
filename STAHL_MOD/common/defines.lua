...
country = {
	...
	GOLD_TO_CASH_RATE = 0.0, -- Amount of money generated per gold unit
	...
	NAVAL_BASE_SUPPLY_SCORE_BASE = 40, -- base value that is powered by level of naval base. Determines the naval supplying capabilities.
	NAVAL_BASE_SUPPLY_SCORE_EMPTY = 200, -- min value for coastal provinces with no naval base.
...
economy = {
	...
	SHADOWY_FINANCIERS_MAX_LOAN_AMOUNT = 25000,
	MAX_LOAN_CAP_FROM_BANKS = 2.5, -- can loan max % of country tax base from single country
	...
	BANKRUPCY_DURATION = 5, -- Years til a bancrupcy clears all loans
	...
	EMPLOYMENT_HIRE_LOWEST = 0.00125,				-- we Hire pops no slower then x% of total required per day
...
military = {
	...
	BASE_COMBAT_WIDTH = 24,
	POP_MIN_SIZE_FOR_REGIMENT = 1600,
	POP_SIZE_PER_REGIMENT = 3200,
...
diplomacy = {
	...
	BREAKTRUCE_PRESTIGE_ADD_TO_SPHERE = -10,
	BREAKTRUCE_PRESTIGE_RELEASE_PUPPET = -10,
	BREAKTRUCE_PRESTIGE_MAKE_PUPPET = -10,
	BREAKTRUCE_PRESTIGE_DISARMAMENT = -10,
	BREAKTRUCE_PRESTIGE_DESTROY_FORTS = -10,
	BREAKTRUCE_PRESTIGE_DESTROY_NAVAL_BASES = -10,
	BREAKTRUCE_PRESTIGE_REPARATIONS = -10,
	BREAKTRUCE_PRESTIGE_TRANSFER_PROVINCES = -10,
	BREAKTRUCE_PRESTIGE_REMOVE_CORES = 0,
	BREAKTRUCE_PRESTIGE_PRESTIGE = -10,
	BREAKTRUCE_PRESTIGE_CONCEDE = -10,
	BREAKTRUCE_PRESTIGE_STATUS_QUO = -10,
	BREAKTRUCE_PRESTIGE_ANNEX = -10,
	BREAKTRUCE_PRESTIGE_DEMAND_STATE = -10,
	BREAKTRUCE_PRESTIGE_INSTALL_COMMUNIST_GOV_TYPE = -10,
	BREAKTRUCE_PRESTIGE_UNINSTALL_COMMUNIST_GOV_TYPE = -10,
	BREAKTRUCE_PRESTIGE_COLONY = -10,
	...
	WAR_PRESTIGE_COST_TRUCE = 50,
	WAR_PRESTIGE_COST_HONOR_ALLIANCE = -50,
	...
	WAR_FAILED_GOAL_PRESTIGE_BASE = -3,
	...
	GOOD_PEACE_REFUSAL_WAREXH = 1.0, --War exhaustion hit from refusing a good peace offer
...
pops = {
	...
	PDEF_BASE_CON = 27.5,			-- so half'ed effect.
...
ai =
{
	...
	INDUSTRYWORKER_WEIGHT = 17.5, -- ai weight for new industry workers
	EDUCATOR_WEIGHT = 17.5, -- ai weigth for new clergy
	...
	CHANCE_BUILD_NAVAL_BASE = 0.9,
	CHANCE_BUILD_FORT = 0.1,
	CHANCE_INVEST_POP_PROJ = 0.9,
	CHANCE_FOREIGN_INVEST = 0.9,
	TWS_AWARENESS_SCORE_LOW_CAP = 0.75, -- AI will always add CBs if current warscore is less then that number (including TWS)
	...
	PEACE_TIME_FACTOR = 0.625, -- after months of stubbornness the effect of time passed is multiplied by this
	...
	AGGRESSION_BASE = 2.5, -- general AI aggression
	...
	MONTHS_BEFORE_DISBAND = 5, -- Months from start date before AI will disband armies/navies (to avoid disbands because of early economic turmoil)
},
